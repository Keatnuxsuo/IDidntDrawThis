...
def generate_art(path: str):
    ...
    image = Image.new("RGB", size=(image_size_px, image_size_px), color=image_bg_colour)
    ...
    for i, point in enumerate(points):
        #overlay
        overlay_image = Image.new("RGB", size=(image_size_px, image_size_px), color=image_bg_colour)
